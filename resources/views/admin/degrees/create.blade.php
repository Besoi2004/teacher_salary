...
@section('page-title', 'Thêm Bằng cấp mới')
                ...
                <form action="{{ route('admin.degrees.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('mo_ta') is-invalid @enderror" 
                                  ...
                                  name="mo_ta" 
                                  rows="4"
                                  placeholder="Mô tả chi tiết về bằng cấp này...">{{ old('mo_ta') }}</textarea>
                        @error('mo_ta')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2">
                        ...
                        Tên đầy đủ nên mô tả rõ ràng về bằng cấp
                    </li>
                    <li class="mb-2">
                        <i class="fas fa-check text-success me-2"></i>
                    ...
                    <li class="mb-2">
                        <i class="fas fa-check text-success me-2"></i>
                        Mô tả giúp phân biệt các loại bằng cấp
                    </li>
                    <li>
