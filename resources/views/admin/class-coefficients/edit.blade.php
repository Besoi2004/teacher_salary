...
@section('title', 'Chỉnh sửa Hệ số Lớp')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Chỉnh sửa Hệ số Lớp</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.class-coefficients.update', $classCoefficient) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('tu_sv') is-invalid @enderror" 
                                           id="tu_sv" name="tu_sv" value="{{ old('tu_sv', $classCoefficient->tu_sv) }}" 
                                           min="0" required>
                                    @error('tu_sv')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('den_sv') is-invalid @enderror" 
                                           id="den_sv" name="den_sv" value="{{ old('den_sv', $classCoefficient->den_sv) }}" 
                                           min="0" required>
                                    @error('den_sv')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('he_so') is-invalid @enderror" 
                                           id="he_so" name="he_so" value="{{ old('he_so', $classCoefficient->he_so) }}" 
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('trang_thai') is-invalid @enderror" 
                                        ...
                                        <option value="1" {{ old('trang_thai', $classCoefficient->trang_thai) == 1 ? 'selected' : '' }}>Hoạt động</option>
                                        <option value="0" {{ old('trang_thai', $classCoefficient->trang_thai) == 0 ? 'selected' : '' }}>Ngưng hoạt động</option>
                                    </select>
                                    @error('trang_thai')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('mo_ta') is-invalid @enderror" 
                                      ...
                                      placeholder="Mô tả về hệ số lớp này...">{{ old('mo_ta', $classCoefficient->mo_ta) }}</textarea>
                            @error('mo_ta')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
